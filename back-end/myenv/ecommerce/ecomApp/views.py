...
products = pd.read_json('C:\\Users\\hp\\Desktop\\django-rest-framework-react\\back-end\\myenv\\ecommerce\\ecomApp\\products.json')
...
def recommend_products(request):
    ...
    recommended_list = recommended_products[['id','title', 'category', 'description','image']].to_dict(orient='records')
